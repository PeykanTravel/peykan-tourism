/**
 * Tour Options Selector Component
 * 
 * Component for selecting additional options for tours
 */
...
export default function TourOptionsSelector({ 
  tourId, 
  onOptionsSelected 
}: TourOptionsSelectorProps) {
  const t = useTranslations('tourOptionsSelector');
      ...
      const mockOptions: TourOption[] = [
        {
          ...
          description: 'Upgrade to a professional licensed guide',
          price: 30,
          type: 'upgrade',
          max_quantity: 1,
        },
        {
          id: '2',
          name: 'Lunch Package',
          description: 'Traditional local lunch at a recommended restaurant',
          price: 20,
          type: 'addon',
          max_quantity: 10,
        },
        {
          ...
          description: 'Upgrade to luxury vehicle with AC and WiFi',
          price: 25,
          type: 'upgrade',
          max_quantity: 1,
        },
        {
          id: '4',
          name: 'Photo Package',
          description: 'Professional photography service during the tour',
          price: 40,
          type: 'addon',
          max_quantity: 5,
        },
        ...
        },
        {
          id: '6',
          name: 'Insurance',
          description: 'Travel insurance coverage for the tour',
          price: 10,
          type: 'addon',
          max_quantity: 10,
        },
