/**
 * Transfer Options Selector Component
 * 
 * Component for selecting additional options for transfers
 */
...
export default function TransferOptionsSelector({ 
  transferId, 
  onOptionsSelected 
}: TransferOptionsSelectorProps) {
  const t = useTranslations('transferOptionsSelector');
      ...
      const mockOptions: TransferOption[] = [
        {
          ...
          description: 'Driver will meet you at the arrival gate with a sign',
          price: 15,
          type: 'addon',
          max_quantity: 1,
        },
        {
          id: '2',
          name: 'Child Seat',
          description: 'Safe child seat for children under 12 years old',
          price: 10,
          type: 'addon',
          max_quantity: 3,
        },
        {
          id: '3',
          name: 'Extra Luggage',
          description: 'Additional luggage space for oversized items',
          price: 20,
          type: 'addon',
          max_quantity: 2,
        },
        {
          id: '4',
          name: 'WiFi Hotspot',
          description: 'Mobile WiFi hotspot during the journey',
          price: 8,
          type: 'addon',
          max_quantity: 1,
        },
        {
          id: '5',
          name: 'Refreshments',
          description: 'Bottled water and snacks during the trip',
          price: 12,
          type: 'addon',
          max_quantity: 5,
        },
        {
          id: '6',
          name: 'Insurance',
          description: 'Travel insurance coverage for the transfer',
          price: 5,
          type: 'addon',
          max_quantity: 10,
        },
