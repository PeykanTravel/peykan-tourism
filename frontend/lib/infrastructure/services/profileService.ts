...
class ProfileService {
  ...
  async requestSensitiveFieldUpdate(data: SensitiveFieldRequest): Promise<SensitiveFieldResponse> {
    try {
      ...
      return {
        success: false,
        message: error.message || 'Failed to request sensitive field update',
      };
    }
  }
  ...
  async verifySensitiveFieldUpdate(data: SensitiveFieldVerify): Promise<ProfileResponse> {
    try {
      ...
      return {
        success: false,
        message: error.message || 'Failed to verify sensitive field update',
      };
    }
  }
  ...
  async resendEmailOTP(): Promise<{ success: boolean; message: string }> {
    try {
      ...
      return { success: false, message: error.message || 'Failed to resend email OTP' };
    }
  }
  ...
  async resendPhoneOTP(): Promise<{ success: boolean; message: string }> {
    try {
      ...
      return { success: false, message: error.message || 'Failed to resend phone OTP' };
    }
  }
}
